  ...
  computed: {
    distance: function () {
      ...
      if (this.item && this.item2) {
        ...
        var theta =
          this.item.geometry.coordinates[1] -
          this.item2.geometry.coordinates[1];
